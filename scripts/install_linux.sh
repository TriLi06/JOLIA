...
echo "  3. Modelle vorbereiten: ollama pull qwen2.5:3b && ollama pull qwen2.5:7b && ollama pull minicpm-v && ollama pull bge-m3"
echo "     Der Modell-Load in RAM/VRAM erfolgt erst bei tatsächlicher Nutzung."
