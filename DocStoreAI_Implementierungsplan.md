# DocStoreAI – Vollständiger Implementierungsplan

**Erstellt:** 2026-06-23  
**Basis:** AI Archive Assistant Architecture & Implementation Blueprint  
**Ziel:** Lokale, KI-gestützte Dokumentenverwaltung ohne Cloud, ohne Docker, ohne GPU
...
DocStoreAI ist eine vollständig lokal betriebene, browserbasierende Dokumentenverwaltungslösung. Sie ermöglicht:
...
paths:
  ...
  backup_target: "/mnt/external_backup/docstoreai_backup"
...
```env
INBOX_PATH=C:/dev/docstoreai-test/inbox
ARCHIVE_ROOT=C:/dev/docstoreai-test/source_documents
DATA_DIR=C:/dev/docstoreai-test/data
OLLAMA_BASE_URL=http://localhost:11434
OLLAMA_MODEL=qwen2.5:3b
DEBUG=true
```
